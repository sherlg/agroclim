...
#'
#' This assumption is valid for temperature variables, which often approximate a normal distribution
#' when aggregated over specific time periods. However, **this method is not appropriate for other types of variables**
#' (e.g., precipitation or wind speed).
#'
...
#' event_prob_teo(any = temp_min, dates = date_seq, threshold = 0, direction = "leq", time_scale = "day", target_date = "01-15")
#' 
#' @import zoo
#' @export

event_prob_teo <- function(any, dates, start_day = "07-01", end_day = "06-30", threshold = 0, direction = "geq", time_scale = "season", target_date = NULL) {
  # Validate inputs
