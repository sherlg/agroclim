library(testthat)
library(zoo)
source("R/event_prob_teo.R")

#' Test for the 'event_prob_teo' function
#'

#' @export
test_that("Test 1 for 'event_prob_teo' function", {
  # Test data
  set.seed(123) 
...
test_that("Test 2 for 'event_prob_teo' function", {
  # Test data
  set.seed(123) 
  dates <- seq(as.Date("2018-10-01"), as.Date("2022-03-31"), by = "day")
  data <- round(runif(length(dates), min = -2, max = 10), 1)
...
test_that("Test 3 for 'event_prob_teo' function", {
  # Test data
  set.seed(123) 
  dates <- seq(as.Date("2018-10-01"), as.Date("2022-03-31"), by = "day")
  data <- round(runif(length(dates), min = -2, max = 10), 1)
