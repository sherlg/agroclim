...
test_that("Test for 'ndays_thre_2var' function using default parameters", {
  ...
  # Test
  result <- ndays_thre_2var(any = data1, any2 = data2, dates = dates) 
...
test_that("Test for 'ndays_thre_2var' function especifying period", {
  ...
  # Test
  result <- ndays_thre_2var(any = data1, any2 = data2, dates, start_day = "01-01", end_day = "04-30") 
...
test_that("Test for 'ndays_thre_2var' function especifying thresholds", {
  ...
  # Test
  result <- ndays_thre_2var(any = data1, any2 = data2, dates = dates, start_day = "01-01", end_day = "04-30", 
